...
class ChoiceForm(object):
    """This form will contain  mmultiple instances of
    two models Question and Answers """
    def __init__(self, data=None, user=None, num_of_questions=10, type_of_quiz=None):
#        self.generated_ids = ''
        self.user = user
        self.data = data
